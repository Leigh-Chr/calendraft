...
type TagObject = { category?: string; resource?: string };
 ...
 * @param tagString - Comma-separated string of tags, or array of objects
 * @returns Array of trimmed, non-empty tags
 */
export function parseTags(
	tagString: string | undefined | TagObject[],
): string[] {
	if (!tagString) return [];
...
/**
 * Get the last tag from a comma-separated string
 * @param tagString - Comma-separated string of tags, or array of objects
...
/**
 * Check if a tag exists in a comma-separated string
 */
